...
describe('Admin Availability API Integration Tests', () => {
  ...
  describe('GET /api/admin/availability/settings', () => {
    ...
    test('should require authentication', async () => {
      const response = await request(app).get('/api/admin/availability/settings').expect(401);
  ...
  describe('GET /api/admin/availability/blocked-dates', () => {
    ...
    test('should require authentication', async () => {
      const response = await request(app).get('/api/admin/availability/blocked-dates').expect(401);
