...
describe('Public Availability API Integration Tests', () => {
  ...
  describe('GET /api/availability/dates', () => {
    test('should return available dates', async () => {
      const response = await request(app).get('/api/availability/dates').expect(200);
  ...
  describe('GET /api/availability/slots/:date', () => {
    test('should return available slots for valid future date', async () => {
      ...
      const response = await request(app).get(`/api/availability/slots/${futureDate}`).expect(200);
    ...
    test('should reject invalid date format', async () => {
      const response = await request(app).get('/api/availability/slots/invalid-date').expect(400);
    ...
    test('should handle past dates', async () => {
      ...
      const response = await request(app).get(`/api/availability/slots/${pastDate}`).expect(200);
    ...
    test('should handle weekend dates (if weekends are blocked)', async () => {
      ...
      const response = await request(app).get(`/api/availability/slots/${saturday}`).expect(200);
  ...
  describe('GET /api/availability/next', () => {
    test('should return next available slot', async () => {
      const response = await request(app).get('/api/availability/next').expect(200);
