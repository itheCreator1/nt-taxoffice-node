...
async function cancelAppointment() {
  ...
  confirmCancelBtn.innerHTML =
    '<span class="spinner" style="width:16px;height:16px;margin-right:8px;"></span>Ακύρωση...';
...
async function init() {
  ...
  if (!currentToken) {
    loadingContainer.style.display = 'none';
    showMessage(
      'Μη έγκυρος σύνδεσμος ακύρωσης. Παρακαλώ χρησιμοποιήστε τον σύνδεσμο από το email σας.',
      'error'
    );
    return;
  }
