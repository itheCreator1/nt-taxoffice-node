  ...
  try {
    ...
    switch (queueItem.email_type) {
      ...
      case 'appointment-confirmed':
        await emailService.sendAppointmentConfirmed(data);
        break;

      case 'appointment-declined':
        await emailService.sendAppointmentDeclined(data);
        break;
...
async function getQueueStats() {
  ...
  try {
    ...
    const [totalCount] = await db.query('SELECT COUNT(*) as total FROM email_queue');
