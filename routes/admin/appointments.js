...
router.get('/', asyncHandler(async (req, res) => {
    ...
    const allowedSortFields = ['appointment_date', 'appointment_time', 'created_at', 'status', 'client_name'];
...
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (appointment_date || appointment_time) {
            const newDate = appointment_date ? toMySQLDate(appointment_date) : appointment.appointment_date;
